"""
HIGHLY MODIFIED Version of Evennia's cmdhandler.
    ...
    **kwargs,
    ...
    def _run_command(
        ...
        try:
            ...
            cmd.playview = session.playview if session else None
